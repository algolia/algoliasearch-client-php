...
class UsageClient
{
     ...
     * @param string $startDate      Start date in ISO 8601 format of the time period to analyze. (required)
     * @param string $endDate        End date in ISO 8601 format of the time period to analyze. (required)
