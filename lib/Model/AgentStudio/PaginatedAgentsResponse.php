...
/**
 * PaginatedAgentsResponse Class Doc Comment.
 *
 * @category Class
 */
class PaginatedAgentsResponse extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        'data' => '\Algolia\AlgoliaSearch\Model\AgentStudio\AgentWithVersionResponse[]',
     ...
     * Sets data.
     *
     * @param AgentWithVersionResponse[] $data data
     *
     * @return self
     */
