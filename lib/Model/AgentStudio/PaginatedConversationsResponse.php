...
/**
 * PaginatedConversationsResponse Class Doc Comment.
 *
 * @category Class
 */
class PaginatedConversationsResponse extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
     ...
     * Sets data.
     *
     * @param ConversationBaseResponse[] $data data
     *
     * @return self
     */
