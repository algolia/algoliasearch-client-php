...
/**
 * ProviderAuthenticationPatch Class Doc Comment.
 *
 * @category Class
 */
class ProviderAuthenticationPatch extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
