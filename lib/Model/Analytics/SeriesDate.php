...
/**
 * SeriesDate Class Doc Comment.
 *
 * @category Class
 */
class SeriesDate extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
     ...
     * Sets date.
     *
     * @param string $date day, formatted as YYYY-MM-DD
     *
     * @return self
     */
     ...
     * Sets metrics.
     *
     * @param array<string,mixed> $metrics metric values for the day
     *
     * @return self
     */
