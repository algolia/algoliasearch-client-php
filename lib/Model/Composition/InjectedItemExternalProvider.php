...
/**
 * InjectedItemExternalProvider Class Doc Comment.
 *
 * @category Class
 */
class InjectedItemExternalProvider extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
