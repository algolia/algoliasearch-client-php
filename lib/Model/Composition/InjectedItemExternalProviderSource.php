...
/**
 * InjectedItemExternalProviderSource Class Doc Comment.
 *
 * @category Class
 *
 * @description Injected items will originate from a request to an external provider configuration.
 */
class InjectedItemExternalProviderSource extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
