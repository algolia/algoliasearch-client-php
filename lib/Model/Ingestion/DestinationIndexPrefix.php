...
/**
 * DestinationIndexPrefix Class Doc Comment.
 *
 * @category Class
 */
class DestinationIndexPrefix extends \Algolia\AlgoliaSearch\Model\AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
