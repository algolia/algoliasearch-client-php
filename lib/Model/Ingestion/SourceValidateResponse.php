...
/**
 * SourceValidateResponse Class Doc Comment.
 *
 * @category Class
 */
class SourceValidateResponse extends \Algolia\AlgoliaSearch\Model\AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
