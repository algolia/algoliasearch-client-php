 ...
 */
class ConvertedObjectIDsAfterSearch extends \Algolia\AlgoliaSearch\Model\AbstractModel implements
    ModelInterface,
    \ArrayAccess,
    \JsonSerializable
{
    ...
    public function setEventName($eventName)
    {
        if (mb_strlen($eventName) > 64) {
            throw new \InvalidArgumentException(
                'invalid length for $eventName when calling ConvertedObjectIDsAfterSearch., must be smaller than or equal to 64.'
            );
        }
        if (mb_strlen($eventName) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $eventName when calling ConvertedObjectIDsAfterSearch., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setObjectIDs($objectIDs)
    {
        if (count($objectIDs) > 20) {
            throw new \InvalidArgumentException(
                'invalid value for $objectIDs when calling ConvertedObjectIDsAfterSearch., number of items must be less than or equal to 20.'
            );
        }
        if (count($objectIDs) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $objectIDs when calling ConvertedObjectIDsAfterSearch., number of items must be greater than or equal to 1.'
            );
        }
    ...
    public function setQueryID($queryID)
    {
        if (mb_strlen($queryID) > 32) {
            throw new \InvalidArgumentException(
                'invalid length for $queryID when calling ConvertedObjectIDsAfterSearch., must be smaller than or equal to 32.'
            );
        }
        if (mb_strlen($queryID) < 32) {
            throw new \InvalidArgumentException(
                'invalid length for $queryID when calling ConvertedObjectIDsAfterSearch., must be bigger than or equal to 32.'
            );
        }
        if (!preg_match('/[0-9a-f]{32}/', $queryID)) {
            throw new \InvalidArgumentException(
                "invalid value for $queryID when calling ConvertedObjectIDsAfterSearch., must conform to the pattern /[0-9a-f]{32}/."
            );
        }
    ...
    public function setUserToken($userToken)
    {
        if (mb_strlen($userToken) > 128) {
            throw new \InvalidArgumentException(
                'invalid length for $userToken when calling ConvertedObjectIDsAfterSearch., must be smaller than or equal to 128.'
            );
        }
        if (mb_strlen($userToken) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $userToken when calling ConvertedObjectIDsAfterSearch., must be bigger than or equal to 1.'
            );
        }
        if (!preg_match('/[a-zA-Z0-9_=\/+-]{1,128}/', $userToken)) {
            throw new \InvalidArgumentException(
                "invalid value for $userToken when calling ConvertedObjectIDsAfterSearch., must conform to the pattern /[a-zA-Z0-9_=\/+-]{1,128}/."
            );
        }
