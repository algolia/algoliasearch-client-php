    ...
    */
    ...
    public function setUserToken($userToken)
    {
        if ((mb_strlen($userToken) > 128)) {
            throw new \InvalidArgumentException('invalid length for $userToken when calling ViewedObjectIDs., must be smaller than or equal to 128.');
        }
        ...
        if ((!preg_match("/[a-zA-Z0-9_=\/+-]{1,128}/", $userToken))) {
            throw new \InvalidArgumentException("invalid value for $userToken when calling ViewedObjectIDs., must conform to the pattern /[a-zA-Z0-9_=\/+-]{1,128}/.");
        }
