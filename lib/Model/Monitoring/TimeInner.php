...
/**
 * TimeInner Class Doc Comment
 *
 * @category Class
 * @package Algolia\AlgoliaSearch
 */
class TimeInner extends \Algolia\AlgoliaSearch\Model\AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
