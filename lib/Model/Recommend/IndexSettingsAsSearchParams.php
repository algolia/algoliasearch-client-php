 ...
 */
class IndexSettingsAsSearchParams extends \Algolia\AlgoliaSearch\Model\AbstractModel implements
        ModelInterface,
        \ArrayAccess,
        \JsonSerializable
{
    ...
    public function setMinProximity($minProximity)
    {
        if (!is_null($minProximity) && $minProximity > 7) {
            throw new \InvalidArgumentException(
                'invalid value for $minProximity when calling IndexSettingsAsSearchParams., must be smaller than or equal to 7.'
            );
        }
        if (!is_null($minProximity) && $minProximity < 1) {
            throw new \InvalidArgumentException(
                'invalid value for $minProximity when calling IndexSettingsAsSearchParams., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setMaxFacetHits($maxFacetHits)
    {
        if (!is_null($maxFacetHits) && $maxFacetHits > 100) {
            throw new \InvalidArgumentException(
                'invalid value for $maxFacetHits when calling IndexSettingsAsSearchParams., must be smaller than or equal to 100.'
            );
        }
