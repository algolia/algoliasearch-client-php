...
class IndexSettingsAsSearchParams extends \Algolia\AlgoliaSearch\Model\AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param null|\Algolia\AlgoliaSearch\Model\Recommend\AlternativesAsExact[] $alternativesAsExact Alternatives of query words that should be considered as exact matches by the Exact ranking criterion.  <dl> <dt><code>ignorePlurals</code></dt> <dd>  Plurals and similar declensions added by the `ignorePlurals` setting are considered exact matches.  </dd> <dt><code>singleWordSynonym</code></dt> <dd> Single-word synonyms, such as \"NY/NYC\" are considered exact matches. </dd> <dt><code>multiWordsSynonym</code></dt> <dd> Multi-word synonyms, such as \"NY/New York\" are considered exact matches. </dd> </dl>.
     *
     * @return self
     */
    ...
    public function setMaxValuesPerFacet($maxValuesPerFacet)
    {
        if (!is_null($maxValuesPerFacet) && ($maxValuesPerFacet > 1000)) {
            throw new \InvalidArgumentException('invalid value for $maxValuesPerFacet when calling IndexSettingsAsSearchParams., must be smaller than or equal to 1000.');
        }
