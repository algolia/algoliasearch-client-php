...
/**
 * BrowsePagination Class Doc Comment.
 *
 * @category Class
 */
class BrowsePagination extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    public function setPage($page)
    {
        if (!is_null($page) && ($page < 0)) {
            throw new \InvalidArgumentException('invalid value for $page when calling BrowsePagination., must be bigger than or equal to 0.');
        }
    ...
    public function setHitsPerPage($hitsPerPage)
    {
        if (!is_null($hitsPerPage) && ($hitsPerPage > 1000)) {
            throw new \InvalidArgumentException('invalid value for $hitsPerPage when calling BrowsePagination., must be smaller than or equal to 1000.');
        }
        if (!is_null($hitsPerPage) && ($hitsPerPage < 1)) {
            throw new \InvalidArgumentException('invalid value for $hitsPerPage when calling BrowsePagination., must be bigger than or equal to 1.');
        }
