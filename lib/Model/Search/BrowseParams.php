 ...
 */
class BrowseParams extends \Algolia\AlgoliaSearch\Model\AbstractModel implements
    ModelInterface,
    \ArrayAccess,
    \JsonSerializable
{
    ...
    public function setLength($length)
    {
        if (!is_null($length) && $length > 1000) {
            throw new \InvalidArgumentException(
                'invalid value for $length when calling BrowseParams., must be smaller than or equal to 1000.'
            );
        }
        if (!is_null($length) && $length < 1) {
            throw new \InvalidArgumentException(
                'invalid value for $length when calling BrowseParams., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setMinimumAroundRadius($minimumAroundRadius)
    {
        if (!is_null($minimumAroundRadius) && $minimumAroundRadius < 1) {
            throw new \InvalidArgumentException(
                'invalid value for $minimumAroundRadius when calling BrowseParams., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setMinProximity($minProximity)
    {
        if (!is_null($minProximity) && $minProximity > 7) {
            throw new \InvalidArgumentException(
                'invalid value for $minProximity when calling BrowseParams., must be smaller than or equal to 7.'
            );
        }
        if (!is_null($minProximity) && $minProximity < 1) {
            throw new \InvalidArgumentException(
                'invalid value for $minProximity when calling BrowseParams., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setMaxFacetHits($maxFacetHits)
    {
        if (!is_null($maxFacetHits) && $maxFacetHits > 100) {
            throw new \InvalidArgumentException(
                'invalid value for $maxFacetHits when calling BrowseParams., must be smaller than or equal to 100.'
            );
        }
