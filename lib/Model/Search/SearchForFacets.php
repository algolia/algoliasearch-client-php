 ...
 * @category Class
 */
class SearchForFacets extends \Algolia\AlgoliaSearch\Model\AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    public function setPage($page)
    {
        if (!is_null($page) && ($page < 0)) {
            throw new \InvalidArgumentException('invalid value for $page when calling SearchForFacets., must be bigger than or equal to 0.');
        }
    ...
    public function setLength($length)
    {
        if (!is_null($length) && ($length > 1000)) {
            throw new \InvalidArgumentException('invalid value for $length when calling SearchForFacets., must be smaller than or equal to 1000.');
        }
        if (!is_null($length) && ($length < 1)) {
            throw new \InvalidArgumentException('invalid value for $length when calling SearchForFacets., must be bigger than or equal to 1.');
        }
    ...
    public function setMinimumAroundRadius($minimumAroundRadius)
    {
        if (!is_null($minimumAroundRadius) && ($minimumAroundRadius < 1)) {
            throw new \InvalidArgumentException('invalid value for $minimumAroundRadius when calling SearchForFacets., must be bigger than or equal to 1.');
        }
    ...
    public function setPersonalizationImpact($personalizationImpact)
    {
        if (!is_null($personalizationImpact) && ($personalizationImpact > 100)) {
            throw new \InvalidArgumentException('invalid value for $personalizationImpact when calling SearchForFacets., must be smaller than or equal to 100.');
        }
        if (!is_null($personalizationImpact) && ($personalizationImpact < 0)) {
            throw new \InvalidArgumentException('invalid value for $personalizationImpact when calling SearchForFacets., must be bigger than or equal to 0.');
        }
    ...
    public function setHitsPerPage($hitsPerPage)
    {
        if (!is_null($hitsPerPage) && ($hitsPerPage > 1000)) {
            throw new \InvalidArgumentException('invalid value for $hitsPerPage when calling SearchForFacets., must be smaller than or equal to 1000.');
        }
        if (!is_null($hitsPerPage) && ($hitsPerPage < 1)) {
            throw new \InvalidArgumentException('invalid value for $hitsPerPage when calling SearchForFacets., must be bigger than or equal to 1.');
        }
    ...
    public function setMinProximity($minProximity)
    {
        if (!is_null($minProximity) && ($minProximity > 7)) {
            throw new \InvalidArgumentException('invalid value for $minProximity when calling SearchForFacets., must be smaller than or equal to 7.');
        }
        if (!is_null($minProximity) && ($minProximity < 1)) {
            throw new \InvalidArgumentException('invalid value for $minProximity when calling SearchForFacets., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxFacetHits($maxFacetHits)
    {
        if (!is_null($maxFacetHits) && ($maxFacetHits > 100)) {
            throw new \InvalidArgumentException('invalid value for $maxFacetHits when calling SearchForFacets., must be smaller than or equal to 100.');
        }
    ...
    public function setMaxValuesPerFacet($maxValuesPerFacet)
    {
        if (!is_null($maxValuesPerFacet) && ($maxValuesPerFacet > 1000)) {
            throw new \InvalidArgumentException('invalid value for $maxValuesPerFacet when calling SearchForFacets., must be smaller than or equal to 1000.');
        }
