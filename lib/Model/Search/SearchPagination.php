 ...
 * @category Class
 */
class SearchPagination extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    {
        if ($page < 0) {
            throw new \InvalidArgumentException('invalid value for $page when calling SearchPagination., must be bigger than or equal to 0.');
        }
    ...
    {
        if ($hitsPerPage > 1000) {
            throw new \InvalidArgumentException('invalid value for $hitsPerPage when calling SearchPagination., must be smaller than or equal to 1000.');
        }
        if ($hitsPerPage < 1) {
            throw new \InvalidArgumentException('invalid value for $hitsPerPage when calling SearchPagination., must be bigger than or equal to 1.');
        }
