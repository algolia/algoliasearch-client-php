...
/**
 * StatisticEntry Class Doc Comment.
 *
 * @category Class
 */
class StatisticEntry extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        't' => 'int',
        'v' => '\Algolia\AlgoliaSearch\Model\Usage\StatisticValue',
    ];
